...
const info = [
    {
        icon: <FaPhoneAlt />,
        title: "Phone",
        description: "+8801688166619",
    },
    {
        icon: <FaEnvelope />,
        title: "Email",
        description: "si.arif.cse@gmail.com",
    },
    {
        icon: <FaMapMarkerAlt />,
        title: "Address",
        description: "152/2/K, Panthapath, Green Road, Dhaka-1205",
    },
];
                ...
                <div className="flex flex-col xl:flex-row gap-[30px]">
                    ...
                    <div className="xl:w-[54%] order-2 xl:order-none">
                        <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                            ...
                            <p className="text-white/60">I'm commited with you for a best service.</p>
                            {/* input */}
